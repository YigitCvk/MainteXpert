...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
{
    ...
    options.Audience = "resource_workorder";
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("NormalPolicy", policy =>
    {
        ...
        policy.RequireClaim("scope", "workorder_fullpermission");
    });
});
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "MainteXpert.WorkOrderService",
        Version = "v1",
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MainteXpert.WorkOrder v1"));
}
