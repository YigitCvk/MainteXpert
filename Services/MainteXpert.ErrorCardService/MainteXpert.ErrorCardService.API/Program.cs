...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
{
    ...
    options.Audience = "resource_errorcard";
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("NormalPolicy", policy =>
    {
        ...
        policy.RequireClaim("scope", "errorcard_fullpermission");
    });
});
...
builder.Services.AddLoggingConfigration(config); // Ensure namespace is correct
builder.Services.AddAppInfrastructure(); // Ensure namespace is correct
